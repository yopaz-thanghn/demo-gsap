...
import car1 from '@/assets/animation-page/car-1.jpg'
import car2 from '@/assets/animation-page/car-2.jpg'
import car3 from '@/assets/animation-page/car-3.jpg'
import { onMounted, useTemplateRef } from 'vue'
import background from '@/assets/animation-page/background.jpg'
import { gsap } from 'gsap'
import { carFeatures } from '@/constants/car-features'
import greenCarPart1 from '@/assets/animation-page/car-part/green-car-part-1.png'
import greenCarPart2 from '@/assets/animation-page/car-part/green-car-part-2.png'
import greenCarPart3 from '@/assets/animation-page/car-part/green-car-part-3.png'
import tealCarPart1 from '@/assets/animation-page/car-part/image.png'
import tealCarPart2 from '@/assets/animation-page/car-part/image (1).png'
import tealCarPart3 from '@/assets/animation-page/car-part/image (2).png'
import whiteCar1 from '@/assets/animation-page/car-part/white-car-1.png'
import whiteCar2 from '@/assets/animation-page/car-part/white-car-2.png'
import whiteCar3 from '@/assets/animation-page/car-part/white-car-3.png'
import blackCar1 from '@/assets/animation-page/car-part/black-car-1.png'
import blackCar2 from '@/assets/animation-page/car-part/black-car-2.png'
import blackCar3 from '@/assets/animation-page/car-part/black-car-3.png'
